...
public class ThEThaumcraft implements IThEIntegration {
    ...
    private void registerArcaneRecipes() {
        ...
        List<ItemStack> certusQuartz =
                new ArrayList<>(
                        Arrays.asList(
                                CraftingHelper.getIngredient("crystalCertusQuartz")
                                        .getMatchingStacks()));
        certusQuartz.add(
                AEApi.instance()
                        .definitions()
        ...
        List<ItemStack> netherQuartz =
                new ArrayList<>(
                        Arrays.asList(
                                CraftingHelper.getIngredient("gemQuartz").getMatchingStacks()));
        netherQuartz.add(
                AEApi.instance()
                        .definitions()
                        .materials()
                        .purifiedNetherQuartzCrystal()
                        .maybeStack(1)
                        .orElse(ItemStack.EMPTY));
                ...
                .ifPresent(
                        stack ->
                                ThaumcraftApi.addArcaneCraftingRecipe(
                                        new ResourceLocation(Reference.MOD_ID, "coalescence_core"),
                                        new ShapedArcaneRecipe(
                                                ...
                                                Ingredient.fromStacks(
                                                        certusQuartz.toArray(new ItemStack[0])),
                                                'F',
                                                AEApi.instance()
                                                        .definitions()
                                                        .materials()
        ...
        ThEApi.instance()
                ...
                .ifPresent(
                        stack ->
                                ThaumcraftApi.addArcaneCraftingRecipe(
                                        new ResourceLocation(Reference.MOD_ID, "diffusion_core"),
                                        new ShapedArcaneRecipe(
                                                recipeGroup,
                                                "DIGISENTIA@2",
                                                10,
                                                ...
                                                'Q',
                                                Ingredient.fromStacks(
                                                        netherQuartz.toArray(new ItemStack[0])),
                                                'F',
                                                AEApi.instance()
                                                        .definitions()
                                                        .materials()
        ...
        ThEApi.instance()
                ...
                .ifPresent(
                        stack -> {
                            ThaumcraftApi.addArcaneCraftingRecipe(
                                    new ResourceLocation(Reference.MOD_ID, "essentia_component_1k"),
                                    new ShapedArcaneRecipe(
                                            recipeGroup,
                                            "ESSENTIASTORAGE1k@2",
                                            10,
                                            ...
                                            AEApi.instance()
                                                    ...
                                                    .maybeStack(1)
                                                    .orElse(ItemStack.EMPTY)));
                            this.addFakeCrafting(
                                    new ResourceLocation(
                                            Reference.MOD_ID, "cells/essentia_cell_1k"));
                        });
        ThEApi.instance()
                .items()
                .essentiaComponent4k()
                ...
                .ifPresent(
                        stack -> {
                            ThaumcraftApi.addArcaneCraftingRecipe(
                                    new ResourceLocation(Reference.MOD_ID, "essentia_component_4k"),
                                    new ShapedArcaneRecipe(
                                            recipeGroup,
                                            "ESSENTIASTORAGE4k@2",
                                            10,
                            ...
                            this.addFakeCrafting(
                                    new ResourceLocation(
                                            Reference.MOD_ID, "cells/essentia_cell_4k"));
                        });
        ThEApi.instance()
                .items()
                .essentiaComponent16k()
                .maybeStack(1)
                .ifPresent(
                        stack -> {
                            ThaumcraftApi.addArcaneCraftingRecipe(
                                    new ResourceLocation(
                                            Reference.MOD_ID, "essentia_component_16k"),
                                    new ShapedArcaneRecipe(
                                            recipeGroup,
        ...
        ThEApi.instance()
                .items()
                .essentiaComponent64k()
                .maybeStack(1)
                .ifPresent(
                        stack -> {
                            ThaumcraftApi.addArcaneCraftingRecipe(
                                    new ResourceLocation(
                                            Reference.MOD_ID, "essentia_component_64k"),
                                    new ShapedArcaneRecipe(
                                            recipeGroup,
                            ...
                            this.addFakeCrafting(
                                    new ResourceLocation(
                                            Reference.MOD_ID, "cells/essentia_cell_64k"));
                        });
        ...
        ThEApi.instance()
                ...
                .ifPresent(
                        stack ->
                                ThaumcraftApi.addArcaneCraftingRecipe(
                                        new ResourceLocation(
                                                Reference.MOD_ID, "essentia_export_bus"),
                                        new ShapedArcaneRecipe(
                                                recipeGroup,
                                                "ESSENTIABUSES@2",
                                                20,
        ...
        ThEApi.instance()
                ...
                .ifPresent(
                        stack ->
                                ThaumcraftApi.addArcaneCraftingRecipe(
                                        new ResourceLocation(
                                                Reference.MOD_ID, "essentia_import_bus"),
                                        new ShapedArcaneRecipe(
                                                recipeGroup,
                                                "ESSENTIABUSES@2",
                                                20,
        ...
        ThEApi.instance()
                ...
                .ifPresent(
                        item ->
                                ThaumcraftApi.addArcaneCraftingRecipe(
                                        new ResourceLocation(
                                                Reference.MOD_ID, "essentia_storage_bus"),
        ...
        ThEApi.instance()
                ...
                .ifPresent(
                        essentia -> {
                            ThaumcraftApi.addArcaneCraftingRecipe(
                                    new ResourceLocation(Reference.MOD_ID, "essentia_terminal"),
                                    new ShapelessArcaneRecipe(
                                            recipeGroup,
                                            "ESSENTIATERMINAL@2",
                                            25,
        ...
        ThEApi.instance()
                ...
                .ifPresent(
                        arcane ->
                                ThaumcraftApi.addArcaneCraftingRecipe(
                                        new ResourceLocation(Reference.MOD_ID, "arcane_terminal"),
                                        new ShapelessArcaneRecipe(
                                                recipeGroup,
                                                "ARCANETERMINAL@2",
                                                50,
        ...
        ThEApi.instance()
                ...
                .ifPresent(
                        inscriber ->
                                ThaumcraftApi.addArcaneCraftingRecipe(
                                        new ResourceLocation(Reference.MOD_ID, "arcane_inscriber"),
                                        new ShapelessArcaneRecipe(
                                                recipeGroup,
                                                "ARCANEINSCRIBER@2",
                                                50,
        ...
        ThEApi.instance()
                ...
                .ifPresent(
                        upgrade -> {
                            ThaumcraftApi.addArcaneCraftingRecipe(
                                    new ResourceLocation(Reference.MOD_ID, "upgrade_arcane"),
                                    new ShapelessArcaneRecipe(
                                            recipeGroup,
        ...
        ThEApi.instance()
                ...
                .ifPresent(
                        core ->
                                ThaumcraftApi.addArcaneCraftingRecipe(
                                        new ResourceLocation(Reference.MOD_ID, "knowledge_core"),
                                        new ShapedArcaneRecipe(
                                                recipeGroup,
                                                "KNOWLEDGECORE@2",
                                                100,
    ...
    private void registerInfusionRecipes() {
                ...
                .ifPresent(
                        stack ->
                                ThaumcraftApi.addInfusionCraftingRecipe(
                                        new ResourceLocation(Reference.MOD_ID, "infusion_provider"),
                                        new InfusionRecipe(
                                                "INFUSIONPROVIDER@2",
                                                stack,
                                                2,
        ...
        ThEApi.instance()
                ...
                .ifPresent(
                        stack ->
                                ThaumcraftApi.addInfusionCraftingRecipe(
                                        new ResourceLocation(Reference.MOD_ID, "arcane_assembler"),
                                        new InfusionRecipe(
                                                "ARCANEASSEMBLER@2",
                                                stack,
                                                6,
                                                ...
                                                AEApi.instance()
                                                        ...
                                                        .orElseThrow(
                                                                () ->
                                                                        new NullPointerException(
                                                                                "Missing molecular assembler block for recipe")),
                                                ThEApi.instance()
                                                        .items()
                                                        .coalescenceCore()
                                                        .maybeStack(1)

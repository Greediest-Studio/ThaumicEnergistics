...
public class ThEItems implements IThEItems {
    ...
    public static IItemDefinition createItem(ItemBase item) {
    ...
    private final AdditionalEssentiaCells additionalEssentiaCells;
    ...
    private final AdditionalEssentiaComponents additionalEssentiaComponents;
    ...
    public ThEItems() {
        ...
        this.additionalEssentiaCells = new AdditionalEssentiaCells();
        ...
        this.additionalEssentiaComponents = new AdditionalEssentiaComponents();
